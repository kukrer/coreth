...
go build -ldflags "-X github.com/kukrer/coreth/plugin/evm.GitCommit=$coreth_commit -X github.com/savannahnode/coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
